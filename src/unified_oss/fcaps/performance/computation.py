...
class CounterMapper:
    ...
    def get_supported_vendors(self) -> List[str]:
        ...
        """
        return [vendor.lower() for vendor in self._mappings.keys()]
...
class FormulaEvaluator:
    ...
    def _eval_node(self, node: ast.AST) -> Any:
        ...
        if hasattr(ast, "Num") and isinstance(node, getattr(ast, "Num")):  # Python < 3.8 compatibility
            return node.n
