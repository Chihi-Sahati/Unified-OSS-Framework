...
async def drift_detector():
    ...
    for schedule_id in list(detector._monitoring_schedules.keys()):
        await detector.stop_monitoring(schedule_id)
...
class TestDriftEntry:
    ...
    def test_entry_creation(self):
        ...
        assert entry.severity == DriftSeverity.MODERATE  # Default
...
class TestSeverityClassifier:
    ...
    def test_classify_security_change(self, severity_classifier):
        ...
        assert severity in [DriftSeverity.LOW, DriftSeverity.HIGH, DriftSeverity.CRITICAL]
