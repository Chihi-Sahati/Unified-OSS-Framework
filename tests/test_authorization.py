...
class TestPermission:
    ...
    def test_matches_action(self, sample_permission):
        ...
        assert sample_permission.matches_action(ActionType.WRITE) is False
    ...
    def test_matches_action_all(self):
        ...
        assert permission.matches_action(ActionType.WRITE) is True
...
class TestPolicy:
    ...
    def test_matches_action(self, sample_policy):
        ...
        assert sample_policy.matches_action(ActionType.WRITE) is True
