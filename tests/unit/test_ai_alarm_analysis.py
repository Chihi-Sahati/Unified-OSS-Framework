...
# Add src to path
sys.path.insert(0, '/home/z/my-project/download/unified-oss-framework/src')
...
class TestAIAlarmAnalyzer:
    ...
    def test_external_apis_blocked(self):
        """Verify external APIs are blocked by default"""
        analyzer = AIAlarmAnalyzer(
            models_config_path='/tmp/test_config.yaml',
    ...
    def test_severity_prediction_confidence_range(self):
    ...
    def test_severity_prediction_valid_levels(self):
...
class TestAnomalyDetection:
    ...
    def test_anomaly_detection_boolean_result(self):
...
class TestRootCauseAnalysis:
    ...
    def test_root_cause_analysis_structure(self):
...
class TestZeroTrustIntegration:
    ...
    def test_zero_trust_verification_enabled(self):
    ...
    def test_zero_trust_blocks_unauthorized_operations(self):
...
class TestVendorNormalization:
    ...
    def test_ericsson_alarm_normalization(self):
    ...
    def test_huawei_alarm_normalization(self):
...
class TestAIAgentIntegration:
    ...
    def test_integration_with_fault_management(self):
